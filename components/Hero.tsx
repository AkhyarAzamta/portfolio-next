    ...
    <section className="py-10">
      <div className="container max-w-7xl mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          >
            <Image src="/profile.jpg" alt="Profile" width={400} height={400} className="rounded-full mb-4 w-48 h-48 object-cover ring-2 ring-primary" />
          </motion.div>
          <motion.h1 
          ...
          >
            Frontend Developer | Backend Developer | IoT Engineer
          </motion.p>
          <motion.div 
          ...
          >
            ...
            <motion.a
              href="https://instagram.com/akhyarazamta"
              target="_blank"
              rel="noopener noreferrer"
              className="text-2xl text-gray-600 hover:text-primary dark:text-gray-300 dark:hover:text-primary transition-colors"
              whileHover={{ scale: 1.2 }}
